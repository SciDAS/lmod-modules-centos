...
_generate_lua() {
  cat >> /output/${HISAT_VERSION}.lua <<EOF
help([[
...
# build HISAT2 ${HISAT_VERSION}
#mkdir -p ${LMOD_MODULE_DIR}/hisat2/
mkdir -p ${LMOD_MODULE_DIR}/hisat2/hisat2-${HISAT_VERSION}
wget http://ccb.jhu.edu/software/hisat2/downloads/hisat2-${HISAT_VERSION}-beta-Linux_x86_64.zip
unzip hisat2-${HISAT_VERSION}-beta-Linux_x86_64.zip
cp -R hisat2-${HISAT_VERSION}-beta/. ${LMOD_MODULE_DIR}/hisat2/hisat2-${HISAT_VERSION}
...
${LMOD_MODULE_DIR}/hisat2/hisat2-${HISAT_VERSION}/hisat2 --version

# generate tar.gz
cd ${LMOD_MODULE_DIR}/hisat2
tar -czf hisat2-${HISAT_VERSION}.tar.gz hisat2-${HISAT_VERSION}
cp hisat2-${HISAT_VERSION}.tar.gz /output
